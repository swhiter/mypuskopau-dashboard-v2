  ...
  <div class="card-container">
    ...
    <div class="card-loading" v-if="loading">
      <div role="status" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <svg aria-hidden="true" class="w-12 h-12 text-gray-500 animate-spin fill-white" viewBox="0 0 100 101"
...
.card-loading {
  @apply absolute z-10 -top-4 left-0 w-full h-full rounded-lg bg-accentGray bg-opacity-50
}
</style>